var surveyJSON = {
    "title": "中國與其他國家學生身分確認",
    "description": "用於判斷您的中國與其他國家學生身分相關資格。",
    "pages": [
        {
            "name": "page_china_other_hukou",
            "elements": [
                {
                    "type": "radiogroup",
                    "name": "china_hukou_location_co",
                    "title": "您目前的戶籍所在地為？",
                    "choices": [
                        {
                            "value": "8_provinces",
    ...
    "completedHtmlOnCondition": [
        {
            "expression": "{china_hukou_location_co} = '8_provinces'",
            "html": "<h4>感謝您完成！</h4><p>您的資格為：<b>僑生、陸生</b></p>"
        },
        {
            "expression": "{china_hukou_location_co} = 'other_provinces'",
